...
home_install_%: ##@home install dependencies for the homepage
	@echo "${YELLOW}Installing ${WHITE}home${YELLOW} dependencies${RESET}"
	@cd homepages/${*} && yarn install

home_dev_%: ##@home start homepage for development
	@echo "${YELLOW}Starting ${WHITE}home${YELLOW} development server${RESET}"
	@cd homepages/${*} && yarn dev

home_build_%: ##@home build homepage
	@echo "${YELLOW}Building ${WHITE}home${RESET}"
	@cd homepages/${*} && yarn run build
