        ...
        return (
            <div className="Block Block--Share Share">
                ...
                <div className="Block__Content Share__Options">
                    <Twitter text="The State Of TC: take the survey and help us find out the latest Technical Communication trends https://stateofTC.com #StateOfTC" />
                    <Facebook link="https://stateofTC.com" />
                    <Email
                        subject="The State Of TC"
                        body="The State Of TC: take the survey and help us find out the latest Technical Communication trends https://stateofTC.com"
                    />
                </div>
            </div>
        )
